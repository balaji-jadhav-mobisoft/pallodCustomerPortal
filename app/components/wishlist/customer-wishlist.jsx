    ...
    <div className="wishlist">
      ...
      {data?.data.length ? (
        data?.data?.map((product) => {
            ...
            return (
              <div className="col-3 wishlist-item product-container" key={product.id}>
                  ...
                  <div className="product-img-wrapper position-relative ">
                    ...
                    >
                      <img src={product.productImage} alt="Pallod" className="zoom-img" />
                    </Link>  
                    <div className="position-absolute wishlist-container">
                      <img onClick={() => removeFromWishlist(product.productId, customerId)} src={RemoveWishlist} alt="Pallod" className="mi-lg mi-close wh-20 d-inline-block" />
                    </div>
                  </div>
        ...
        <div className="empty-wishlist-container d-flex justify-content-center align-items-center">
          <div
            className="empty-wishlist-section d-flex flex-column align-items-center justify-content-center">
            ...
            <Link to={'/'}><button className="start-shopping-btn">START SHOPPING</button></Link>
          </div>
        </div>
      )}
        </div>
